    ...
    return (
        <AreaLayout>
            <div className="min-h-full">
                {/* Success Message */}
                {flash?.success && (
                    <div className="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 p-4 rounded-lg shadow-md flex items-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex justify-end gap-4 pt-6 border-t-2 border-gray-100">
                                <button
                                    ...
                                    disabled={processing}
                                    className="px-8 py-3 bg-gradient-to-r from-gray-400 to-gray-500 text-white font-bold rounded-xl hover:from-gray-500 hover:to-gray-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Save as Draft
                                </button>
                                <button
                                    type="button"
                                    onClick={(e) => handleSubmit(e, "On Process")}
                                    disabled={processing}
